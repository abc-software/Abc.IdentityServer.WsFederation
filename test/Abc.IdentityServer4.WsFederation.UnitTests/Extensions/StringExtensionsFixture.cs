...
namespace Abc.IdentityServer.WsFederation.Extensions.UnitTests
{
    public class StringExtensionsFixture {
        ...
        public void ToSpaceSeparatedString(IEnumerable<string> list, string expected)
        {
            var actialString = list.ToSpaceSeparatedString();
            actialString.Should().Be(expected);
        }
